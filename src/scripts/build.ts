...
const generateSoftwarePage = (software: typeof cmmsSoftware[0]) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const generateIndexPage = (softwareList: typeof cmmsSoftware) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const indexHtml = generateIndexPage(cmmsSoftware);
const indexFilePath = path.join(DIST_DIR, 'index.html');
fs.writeFileSync(indexFilePath, indexHtml);
console.log('Generated index.html');

console.log(`Build complete! Generated ${cmmsSoftware.length} software pages.`);
