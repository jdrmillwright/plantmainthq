import { IndustryVertical } from '../types/cmms';

export interface EvaluationCriterion {
  id: string;
  name: string;
  category: 'core' | 'advanced' | 'operational' | 'commercial';
  description: string;
  weight: number; // Multiplier from 0 to 1
}
...
export const INDUSTRY_CONFIGURATIONS: Record<IndustryVertical, { focusKeywords: string[]; primaryKpi: string }> = {
  Manufacturing: {
