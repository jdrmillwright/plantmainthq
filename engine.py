  ...
  <main class="container">
    <section class="hero">
      ...
      <div class="trust-grid" style="margin-top: 2rem;">
        <div class="trust-card">
          ...
          <div class="trust-label">Verified Platforms</div>
        </div>
        <div class="trust-card">
          <div class="trust-number font-mono">5,565</div>
          <div class="trust-label">Comparison Matchups</div>
        </div>
        <div class="trust-card">
    ...
    <section class="controls-card" id="directory">
      <div style="position:relative;">
        <input type="text" id="cmms-search" class="search-input" placeholder="Search 106 platforms by name, vertical, or capability (e.g. Limble, Manufacturing, Offline, IoT, Free Trial)...">
      </div>
